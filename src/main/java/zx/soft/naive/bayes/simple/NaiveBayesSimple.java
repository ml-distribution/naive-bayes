package zx.soft.naive.bayes.simple;
...
import zx.soft.naive.bayes.data.TextTrainDataFactory;
import zx.soft.naive.bayes.data.TrainDataFactory;
...
public class NaiveBayesSimple {
	...
	private static Logger logger = LoggerFactory.getLogger(NaiveBayesSimple.class);
	...
	public static void main(String[] args) {
		...
		NaiveBayesSimple bayes = new NaiveBayesSimple(new TextTrainDataFactory(args[0]));
