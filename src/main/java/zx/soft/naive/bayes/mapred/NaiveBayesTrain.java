 ...
 *
 */
public class NaiveBayesTrain extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job trainWordJob = new Job(conf, "naive-bayes-word-train");
		trainWordJob.setJarByClass(NaiveBayesTrain.class);
		...
		Job trainCateJob = new Job(conf, "naive-bayes-cate-train");
		trainCateJob.setJarByClass(NaiveBayesTrain.class);
	...
	public static void main(String[] args) {
		try {
			int exitCode = ToolRunner.run(new NaiveBayesTrain(), args);
