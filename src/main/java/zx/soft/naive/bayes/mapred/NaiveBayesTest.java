 ...
 *
 */
public class NaiveBayesTest extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job joinJob = new Job(conf, "naive-bayes-test-prep");
		joinJob.setJarByClass(NaiveBayesTest.class);
		...
		classify.setJarByClass(NaiveBayesTest.class);
	...
	public static void main(String[] args) {
		try {
			int exitCode = ToolRunner.run(new NaiveBayesTest(), args);
