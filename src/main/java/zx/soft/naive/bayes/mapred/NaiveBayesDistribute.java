...
public class NaiveBayesDistribute extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job trainWordJob = new Job(conf, "naive-bayes-wordtrain");
		trainWordJob.setJarByClass(NaiveBayesDistribute.class);
		...
		Job trainCateJob = new Job(conf, "naive-bayes-catetrain");
		trainCateJob.setJarByClass(NaiveBayesDistribute.class);
		...
		Job joinJob = new Job(conf, "naive-bayes-testprep");
		joinJob.setJarByClass(NaiveBayesDistribute.class);
		...
		Job classify = new Job(classifyConf, "naive-bayes-classify");
		classify.setJarByClass(NaiveBayesDistribute.class);
	...
	public static void main(String[] args) {
		try {
			int exitCode = ToolRunner.run(new NaiveBayesDistribute(), args);
